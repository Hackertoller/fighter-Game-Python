...
TAKKEN1 = pygame.transform.scale(Takken1,(130,130))
#-----------------------------------------------------
Takken2 = pygame.image.load("images/Takken2.png")
TAKKEN2 = pygame.transform.scale(Takken2,(130,130))
#-----------------------------------------------
Takken3 = pygame.image.load("images/Takken3.png")
TAKKEN3 = pygame.transform.scale(Takken3,(130,130))
#------------------------------------------------
Takken4 = pygame.image.load("images/Takken4.png")
TAKKEN4 = pygame.transform.scale(Takken4,(130,130))
#-------------------------------------------------
Takken5 = pygame.image.load("images/Takken5.png")
TAKKEN5 = pygame.transform.scale(Takken5,(130,130))
#-----------------------------------------------
Takken6 = pygame.image.load("images/Takken6.png")
TAKKEN6 = pygame.transform.scale(Takken6,(130,130))
#-------------------------------------------------
Takken7 = pygame.image.load("images/Takken7.png")
TAKKEN7 = pygame.transform.scale(Takken7,(130,130))
def Bg(folder):
...
def Rival(RivalX,RivalY,RivalPos,folder):
    ...
    try:
        ...
        RIVAL1 = pygame.transform.scale(Rival1,(170,170))
        #------------------------------------------------
        Rival2 = pygame.image.load(f"images/{folder}/rival2.png")
        RIVAL2 = pygame.transform.scale(Rival2,(170,170))
        #-----------------------------------------------
        Rival3 = pygame.image.load(f"images/{folder}/rival3.png")
        RIVAL3 = pygame.transform.scale(Rival3,(170,170))
        #-----------------------------------------------
        Rival4 = pygame.image.load(f"images/{folder}/rival4.png")
        RIVAL4 = pygame.transform.scale(Rival4,(170,170))
    except:
        pass
    if RivalPos == "defulte":
        try:
...
while True:
    ...
    if WidthCharsR == 0:
        ...
        sound.runAndWait()
        if RivalCrashed == 2 or RivalCrashed == 4 or RivalCrashed == 6 or RivalCrashed == 8:
            WidthCharsT = 300
    if WidthCharsT < 5:
        sound.setProperty("rate",100)
